  ...
  template: `
    @if (show()) {
      ...
      >
        ...
        >
          <p class="font-mono text-xs uppercase tracking-[0.35em] text-cyber-cyan">Pliki cookies</p>
          ...
          <p class="mt-4 text-sm leading-relaxed text-slate-300 md:text-base">
            Korzystanie z pełnej funkcjonalności serwisu jest możliwe po wyrażeniu zgody na stosowanie
            plików cookies zgodnie z ustawieniami opisanymi w
            <a
